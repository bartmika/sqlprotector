...
func TestProtectStringValue(t *testing.T) {
	SetSQLProtectorPassphrase([]byte("sdfdsfedrdsfsdfsdfazfasfasdfsdfa"))
	pt := ProtectString{Plaintext: "Hello World"}
	ct, err := pt.Value()
	if err != nil {
		t.Error(err)
	}
...
func TestProtectStringScan(t *testing.T) {
	SetSQLProtectorPassphrase([]byte("sdfdsfedrdsfsdfsdfazfasfasdfsdfa"))
	var pt ProtectString
	expected := "Hello World"

	// CASE 1: String
	ct := "TRB4/EEcxZJ0JE88iVFyD6DucY+lWxB/8ey/L8s2GPz7ew2K84Kr"
	err := pt.Scan(ct)
	if err != nil {
		t.Error(err)
	}
	...
	// CASE 2: []byte
	ct2 := []byte("TRB4/EEcxZJ0JE88iVFyD6DucY+lWxB/8ey/L8s2GPz7ew2K84Kr")
	err = pt.Scan(ct2)
	if err != nil {
		t.Error(err)
	}
...
func TestProtectStringScanForErrors(t *testing.T) {
	SetSQLProtectorPassphrase([]byte("sdfdsfedrdsfsdfsdfazfasfasdfsdfa"))
	var pt ProtectString
